...
export default function Header() {
  return (
    <header className="w-full relative h-[100vh] p-3 bg-[url('/assets/bg-header.png')] bg-center bg-cover">
      <div className="m-auto w-full max-w-6xl p-3 flex flex-col">
        ...
        <div className="flex justify-center absolute bottom-9 left-[49%]">
          <Image
